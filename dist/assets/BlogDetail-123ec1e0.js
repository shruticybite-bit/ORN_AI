import{w as u,r as o,j as r,a as e,L as n,F as c}from"./index-4f69de9b.js";import{N as h,F as m}from"./Footer-0219da3f.js";import{o as a}from"./proxy-51cffaa4.js";import"./createLucideIcon-d8510d22.js";function w(){const{id:i}=u(),[t,s]=o.useState(null),l=[{id:1,title:"The Future of Learning: How ORN-AI Is Empowering Global Talent",excerpt:`
    ...
    `,thumbnail:"https://fastly.picsum.photos/id/1015/800/500.jpg?hmac=pSNYsY7XYU05VD89MUu0QDrVHgAu2yZaGSC4wzh7ld8"},{id:2,title:"Why Ethical Placement Matters — And How ORN-AI Is Changing the Game",excerpt:`
    ...
    `,thumbnail:"https://fastly.picsum.photos/id/1015/800/500.jpg?hmac=pSNYsY7XYU05VD89MUu0QDrVHgAu2yZaGSC4wzh7ld8"},{id:3,title:"The Power of Cross-Technology Training in 2025: Why You Need It",excerpt:`
    ...
    `,thumbnail:"https://fastly.picsum.photos/id/1015/800/500.jpg?hmac=pSNYsY7XYU05VD89MUu0QDrVHgAu2yZaGSC4wzh7ld8"},{id:4,title:"From Classroom to Career: How ORN-AI Supports You Beyond Training",excerpt:`
    ...
    `,thumbnail:"https://fastly.picsum.photos/id/1015/800/500.jpg?hmac=pSNYsY7XYU05VD89MUu0QDrVHgAu2yZaGSC4wzh7ld8"}];return o.useEffect(()=>{const p=l.find(d=>d.id===Number(i));s(p||null)},[i]),t?r(c,{children:[e(h,{}),e("div",{className:"min-h-screen bg-[#0b0718] text-white py-20 px-5 md:px-20",children:r(a.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},className:"max-w-5xl mx-auto",children:[r("div",{className:"relative overflow-hidden rounded-2xl mb-8 group shadow-lg shadow-[#7c4dff25]",children:[e(a.img,{whileHover:{scale:1.05},transition:{duration:.6},src:t.thumbnail,alt:t.title,className:"rounded-2xl w-full object-cover max-h-[500px] transition-transform duration-700 group-hover:brightness-110"}),e("div",{className:"absolute inset-0 bg-gradient-to-t from-[#0b0718]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"})]}),e(a.h1,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.2},className:"text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#7c4dff] to-[#3f95ff]",children:t.title}),e(a.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.3},className:"text-gray-300 leading-relaxed text-lg",dangerouslySetInnerHTML:{__html:t.excerpt}}),e(a.div,{className:"mt-10",initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.4},children:e(n,{to:"/blogs",className:"inline-block px-6 py-3 rounded-full bg-gradient-to-r from-[#7c4dff] to-[#3f95ff] hover:from-[#9b6aff] hover:to-[#5fb8ff] transition-all duration-300 transform hover:scale-110 shadow-[0_0_20px_#7b4dff40] font-medium text-black",children:"← Back to Blogs"})})]})}),e(m,{})]}):r("div",{className:"min-h-screen flex flex-col items-center justify-center text-white bg-[#0b0718]",children:[e("p",{className:"text-lg mb-3",children:"⚠️ Blog not found."}),e(n,{to:"/blogs",className:"px-5 py-2 rounded-lg bg-gradient-to-r from-[#7c4dff] to-[#3f95ff] hover:from-[#9063ff] hover:to-[#66b9ff] transition-all duration-300 transform hover:scale-105 shadow-lg",children:"← Back to Blogs"})]})}export{w as default};
